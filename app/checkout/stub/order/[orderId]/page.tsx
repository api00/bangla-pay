  ...
  return (
    <main className="min-h-screen bg-off-white flex flex-col">
      <header className="px-6 md:px-10 py-6 flex items-center justify-between border-b border-[rgba(14,15,12,0.06)] bg-white">
        ...
        <div className="text-[12px] font-semibold uppercase tracking-[0.18em] text-gray">
          Test checkout
        </div>
      </header>
      ...
      <div className="flex-1 flex items-start justify-center px-5 sm:px-6 py-10 md:py-16">
        <div className="w-full max-w-[480px] space-y-6">
          <div className="rounded-[28px] bg-white border border-[rgba(14,15,12,0.06)] p-6 md:p-8 shadow-[0_2px_0_0_rgba(14,15,12,0.04),0_30px_80px_-40px_rgba(14,15,12,0.18)]">
            ...
            <p
              className="display mt-2 text-[44px] sm:text-[56px] tabular-nums text-near-black"
            ...
            <p className="mt-2 text-[14px] text-warm-dark">
              from{" "}
              <span className="font-semibold text-near-black">
                {orderRow.displayName}
              </span>
              <span className="text-gray"> (@{orderRow.handle})</span>
            </p>
            ...
            <div className="mt-6 pt-5 border-t border-[rgba(14,15,12,0.06)] space-y-2">
              {items.map((item, idx) => (
                ...
                >
                  <span className="text-near-black truncate">{item.title}</span>
                  <span className="text-warm-dark tabular-nums shrink-0">
            ...
            <p className="mt-5 pt-5 border-t border-[rgba(14,15,12,0.06)] text-[12px] text-gray">
