      ...
      <div className="flex-1 flex items-start justify-center px-5 sm:px-6 py-10 md:py-16">
        <div className="w-full max-w-[480px] space-y-6">
          <div className="rounded-[28px] bg-white border border-[rgba(14,15,12,0.06)] p-6 md:p-8 shadow-[0_2px_0_0_rgba(14,15,12,0.04),0_30px_80px_-40px_rgba(14,15,12,0.18)]">
            ...
            <p className="mt-3 text-[14px] text-warm-dark">
              to{" "}
              <span className="font-semibold text-near-black">
                {row.displayName}
              </span>
              <span className="text-gray"> (@{row.handle})</span>
            </p>

            {row.message && (
              <div className="mt-6 pt-5 border-t border-[rgba(14,15,12,0.06)]">
                <p className="text-[12px] font-semibold uppercase tracking-[0.18em] text-gray mb-2">
                  Your note
                </p>
                <p className="text-[14px] text-near-black leading-[1.55] whitespace-pre-line">
                  {row.message}
                </p>
                {row.supporterName && (
