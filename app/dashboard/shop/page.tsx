  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-wrap items-baseline justify-between gap-3">
        <div>
          <h1
            className="display text-[28px] text-[#0e0f0c] md:text-[36px]"
        ...
        <Link
          ...
          className="inline-flex h-11 items-center justify-center rounded-full bg-[#9fe870] px-5 text-[14px] font-semibold text-[#163300] shadow-[0_1px_0_0_rgba(22,51,0,0.15),0_10px_30px_-14px_rgba(159,232,112,0.7)] transition-transform hover:scale-[1.02] active:scale-[0.98]"
        >
          + New product
        </Link>
      </header>
      ...
      {products.length === 0 ? (
        <div className="rounded-3xl border border-dashed border-[rgba(14,15,12,0.14)] bg-white px-8 py-12 text-center">
          ...
          <p className="mx-auto mt-1 max-w-[400px] text-[14px] leading-[1.55] text-[#454745]">
            Add an e-book, audio product, or design pack and deliver it
            securely after purchase.
          </p>
          <Link
            href="/dashboard/shop/new"
            className="mt-5 inline-flex h-11 items-center justify-center rounded-full bg-[#163300] px-5 text-[14px] font-semibold text-white"
          >
