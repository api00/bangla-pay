    ...
    <div className="rounded-[28px] bg-white border border-[rgba(14,15,12,0.06)] p-8 md:p-10 shadow-[0_1px_0_0_rgba(14,15,12,0.03)] text-center max-w-[560px] mx-auto">
      ...
      <div className="mt-5 flex justify-center gap-3 flex-wrap">
        ...
        <button
          ...
          className="h-11 px-5 rounded-full border border-[rgba(14,15,12,0.12)] bg-white text-[#0e0f0c] font-semibold text-[14px] inline-flex items-center justify-center hover:border-[#0e0f0c] transition-colors"
        >
          Reload page
        </button>
      </div>
