...
export default function CopyrightPage() {
  return (
    <main className="min-h-screen bg-[#f7f9f5] text-[#0e0f0c]">
      <div className="mx-auto max-w-[860px] px-5 py-8 sm:px-6 md:py-12">
        <header className="flex items-center justify-between gap-4">
          <Link
            href="/"
            className="inline-flex min-h-11 items-center gap-1.5 rounded-lg focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#163300]"
            aria-label="BanglaPay home"
          >
            <span className="display text-2xl tracking-tight">banglapay</span>
            <span
              aria-hidden
              className="h-1.5 w-1.5 rounded-full bg-[#9fe870]"
            />
          </Link>
          <Link
            href="/"
            className="inline-flex min-h-11 items-center text-[14px] font-semibold text-[#163300] underline decoration-[#9fe870] decoration-2 underline-offset-4 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#163300]"
          >
            Back to home
          </Link>
        </header>
        ...
        <article className="mt-14 md:mt-20">
          <header className="max-w-[720px]">
            <p className="text-[12px] font-semibold uppercase tracking-[0.2em] text-[#454745]">
              Copyright and digital products
            </p>
            <h1
              className="display mt-4 text-[38px] text-[#0e0f0c] sm:text-[52px] md:text-[64px]"
              style={{ lineHeight: 1.02, fontWeight: 900 }}
            >
              Your work stays yours.
            </h1>
            <p className="mt-6 max-w-[680px] text-[17px] leading-[1.65] text-[#454745] md:text-[19px]">
          ...
          >
            ...
            <p className="mt-3 max-w-[680px] text-[16px] leading-[1.65] text-[#454745]">
            ...
            <dl className="mt-6 grid gap-3 sm:grid-cols-3">
              {categories.map((category) => (
                ...
                >
                  <dt className="text-[15px] font-semibold text-[#0e0f0c]">
                    {category.name}
                  </dt>
                  <dd className="mt-1 text-[13px] leading-[1.5] text-[#454745]">
                    {category.formats}
                  </dd>
                </div>
              ))}
          ...
          >
            ...
            <a
              ...
              className="mt-5 inline-flex min-h-12 items-center justify-center rounded-full bg-[#163300] px-6 text-[15px] font-semibold text-white transition-colors hover:bg-[#054d28] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#163300]"
            >
              Email {SUPPORT_EMAIL}
            </a>
          </section>
        ...
        <footer className="mt-16 border-t border-[rgba(14,15,12,0.12)] py-8 text-[13px] text-[#454745]">
