...
const STYLE: Record<FileKind, FileTypeStyle> = {
  image: {
    kind: "image",
    label: "Image",
    tileBg: "bg-gradient-to-br from-[#cdffad] to-[#e2f6d5]",
    iconColor: "text-[#163300]",
  },
  video: {
    kind: "video",
    label: "Video",
    tileBg: "bg-gradient-to-br from-[#fde2df] to-[#fff4d9]",
    iconColor: "text-[#a3221a]",
  },
  audio: {
    kind: "audio",
    label: "Audio",
  ...
  doc: {
    kind: "doc",
    label: "Document",
    tileBg: "bg-gradient-to-br from-[#e2f6d5] to-[#f2f6ec]",
    iconColor: "text-[#163300]",
  },
  spreadsheet: {
    kind: "spreadsheet",
    label: "Spreadsheet",
    tileBg: "bg-gradient-to-br from-[#cdffad] to-[#e2f6d5]",
    iconColor: "text-[#054d28]",
  },
  presentation: {
    kind: "presentation",
    label: "Slides",
    tileBg: "bg-gradient-to-br from-[#fff4d9] to-[#fde2df]",
    iconColor: "text-[#7a5b00]",
  },
  archive: {
    kind: "archive",
    label: "Archive",
    tileBg: "bg-gradient-to-br from-[#e8ebe6] to-[#f7f9f5]",
    iconColor: "text-[#454745]",
  },
  code: {
    kind: "code",
    label: "Code",
    tileBg: "bg-gradient-to-br from-[#0e0f0c] to-[#163300]",
    iconColor: "text-[#9fe870]",
  },
  text: {
    kind: "text",
    label: "Text",
    tileBg: "bg-gradient-to-br from-[#f7f9f5] to-[#e8ebe6]",
    iconColor: "text-[#454745]",
  },
  font: {
    kind: "font",
    label: "Font",
    tileBg: "bg-gradient-to-br from-[#0e0f0c] to-[#454745]",
    iconColor: "text-white",
  },
  "3d": {
    kind: "3d",
    label: "3D",
    tileBg: "bg-gradient-to-br from-[#e8e1ff] to-[#cdffad]",
    iconColor: "text-[#3f2b8c]",
  },
  design: {
    kind: "design",
    label: "Design",
    tileBg: "bg-gradient-to-br from-[#fde2df] to-[#e8e1ff]",
    iconColor: "text-[#a3221a]",
  },
  ebook: {
    kind: "ebook",
    label: "eBook",
    tileBg: "bg-gradient-to-br from-[#fff4d9] to-[#e2f6d5]",
    iconColor: "text-[#7a5b00]",
  },
  executable: {
    kind: "executable",
