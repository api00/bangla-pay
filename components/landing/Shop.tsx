  ...
  return (
    <section id="shop" className="py-20 md:py-28 bg-white overflow-hidden">
      <div className="max-w-5xl mx-auto px-5 lg:px-8">
        <div className="rounded-[36px] bg-[#f7f9f5] border border-[rgba(14,15,12,0.08)] px-6 md:px-12 lg:px-16 py-16 md:py-24 text-center">
        ...
        <div className="mt-16 md:mt-20 relative w-[280px] sm:w-[300px] mx-auto">
          ...
          <div className="relative z-10 rounded-[28px] bg-white border border-[rgba(14,15,12,0.08)] shadow-[0_30px_60px_-24px_rgba(14,15,12,0.18)] overflow-hidden">
            {/* Cover */}
            <div className="relative aspect-[1.15/1] bg-gradient-to-br from-[#9fe870] to-[#cdffad] flex items-center justify-center">
              <span className="absolute top-3.5 left-3.5 bg-white rounded-md px-2 py-0.5 text-[10px] font-bold tracking-wider text-[#0e0f0c] border border-[rgba(14,15,12,0.08)]">
                .PDF
              </span>
              ...
              <div className="relative" aria-hidden>
                {/* Sparkles */}
                <svg
                  className="absolute -top-5 -left-7 w-4 h-4 text-[#163300]"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
                ...
                <svg
                  className="absolute -top-2 right-[-18px] w-3 h-3 text-[#163300]"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
                  <path d="M12 0c.5 6 1.5 7 10 10.5-8.5 3.5-9.5 4.5-10 10.5-.5-6-1.5-7-10-10.5 8.5-3.5 9.5-4.5 10-10.5z" />
                ...
                <svg
                  className="absolute bottom-0 -right-6 w-4 h-4 text-[#163300]"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
                  <path d="M12 0c.5 6 1.5 7 10 10.5-8.5 3.5-9.5 4.5-10 10.5-.5-6-1.5-7-10-10.5 8.5-3.5 9.5-4.5 10-10.5z" />
                ...
                <div className="relative w-[110px] h-[130px] -rotate-[4deg]">
                  ...
                  {/* Cover */}
                  <div className="absolute inset-0 rounded-[6px] bg-[#163300] shadow-[4px_5px_0_rgba(14,15,12,0.18)] flex flex-col items-center justify-center px-3">
                    <span className="bangla-display text-[48px] text-[#9fe870] leading-none">
                      বই
                    </span>
                    <span className="mt-2 text-[8px] font-semibold tracking-[0.2em] uppercase text-[#9fe870]/80">
                      Vol · 2
                    </span>
                  </div>
                </div>
            ...
            <div className="p-5">
              <div className="text-left">
                <h3 className="text-[17px] font-bold tracking-tight text-[#0e0f0c]">
                  Monsoon Stories, Vol. 2
                </h3>
                <div className="flex items-center gap-2 mt-1 text-[12px] text-[#868685]">
                  <span className="font-semibold text-[#0e0f0c] tabular-nums">
                    ৳250
                  </span>
              ...
              <div className="mt-4 space-y-1.5" aria-hidden>
                <div className="h-1.5 rounded-full bg-[#e8ebe6] w-full" />
                <div className="h-1.5 rounded-full bg-[#e8ebe6] w-3/4" />
              </div>
              <button
                type="button"
                className="mt-5 w-full h-12 rounded-full bg-[#9fe870] text-[#163300] font-semibold text-[15px] transition-transform hover:scale-[1.02] active:scale-[0.98]"
              >
                Buy
              </button>
            </div>
          ...
          <div className="hidden md:flex absolute -top-5 -left-28 lg:-left-36 z-20 items-center gap-2 rounded-full bg-white border border-[rgba(14,15,12,0.08)] shadow-[0_10px_30px_-12px_rgba(14,15,12,0.15)] px-3.5 py-2">
            ...
            <span className="text-[12px] font-semibold text-[#0e0f0c] whitespace-nowrap">
              One-tap checkout
            </span>
          </div>
          ...
          <div className="hidden md:block absolute bottom-16 -left-24 lg:-left-32 z-20 rounded-2xl bg-white border border-[rgba(14,15,12,0.08)] shadow-[0_10px_30px_-12px_rgba(14,15,12,0.15)] p-3.5 w-[112px] text-left">
            <div className="w-7 h-7 rounded-lg bg-[#e2f6d5] flex items-center justify-center">
              <svg
                width="14"
                height="14"
                viewBox="0 0 24 24"
            ...
            <div className="text-[22px] font-bold tabular-nums mt-2 text-[#0e0f0c] leading-none">
              753
            </div>
            <div className="text-[11px] text-[#868685] mt-1">Sales</div>
          </div>
          ...
          <div className="hidden md:block absolute top-10 -right-28 lg:-right-36 z-20 rounded-2xl bg-white border border-[rgba(14,15,12,0.08)] shadow-[0_10px_30px_-12px_rgba(14,15,12,0.15)] p-3 w-[168px] text-left">
            <div className="text-[11px] text-[#868685] mb-1.5">
          ...
          <div className="hidden md:flex absolute bottom-24 -right-24 lg:-right-32 z-20 items-center gap-2 rounded-full bg-white border border-[rgba(14,15,12,0.08)] shadow-[0_10px_30px_-12px_rgba(14,15,12,0.15)] px-3.5 py-2">
            <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-[#163300] text-[#9fe870] text-[11px] font-bold">
              ৳
            </span>
            <span className="text-[13px] font-bold tabular-nums text-[#0e0f0c] whitespace-nowrap">
              24,400
            </span>
            <span className="text-[11px] text-[#868685] whitespace-nowrap">
              Earnings
            </span>
          </div>
        </div>
